...
<!-- <meta name="viewport" content="width=device-width, initial-scale=1.0" /> <meta name="yandex-verification" content="3130095486568572" />
 --><!--metatextblock-->
<title>Реферальная программа "Кем Стать?"</title>
...
<strong class='title' style="font-family: Arial; font-size: 62px;">Зарегистрируйся в реферальной программе "Кем Стать?"</strong>
...
<button class="buy-btn" style="width: 350px;">З А Р Е Г И С Т Р И Р О В А Т С Я</button>
<div id="popup" class="popup hidden">
    <div class="popup-content">
        <span class="close-btn">&times;</span>
        <p>Продукт: </br><?=$product['product_name'];?></p>
        <p>Стоимость: <s><?=$price['real_price']?> ₽</s> бесценно </p>
        <form class="form" action="<?=$setting['script_url']?>/buy/36" method="POST"
            ...
            <input class="input-field" type="text" id="first_name" name="name" value="<?=$name?>" required>
                                    ...
                                    <button class="pay" name="buy" type="submit">Зарегистрироваться</button>
        </form>
    </div>
</div>
