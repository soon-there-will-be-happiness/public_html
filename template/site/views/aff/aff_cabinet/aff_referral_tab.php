            ...
            <?php if($links && $user['spec_aff'] == 0) {
                ...
                foreach($links as $link):
                    ...
                    <tr>
                                ...
                                if($link['product_id']!=33 & $link['product_id']!=35) { ?>
                                    ...
                                    <!-- <div class="table-form-line">
                                        ...
                                        <form class="table-form-input" action="" method="POST">
                                            <?php $telegram=false;//$telegram=TelegramProduct::searchByProguctId($link['product_id']);
                                            if($telegram!=false):?>
                        ...
                        <?php if($link['ads'] != null):?><td class="not-aff_links"><a class="text-decoration-none" target="_blank" href="/load/ads/<?=$link['ads']?>"><i class="icon-attach-1"></i>&nbsp;<?=System::Lang('DOWNLOAD');?></a><?php endif;?></td>
                    </tr>
                <?php endforeach;
            } else {
                // ОСОБЫЙ РЕЖИМ
