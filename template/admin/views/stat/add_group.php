...
<div class="main">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="/admin/channels/group/">Группы каналов</a></li>
        <li>Создать группу каналов</li>
    </ul>
    <form action="" method="POST">

        <div class="admin_top admin_top-flex">
            <h3 class="traning-title">Создать группу каналов</h3>
            <ul class="nav_button">
