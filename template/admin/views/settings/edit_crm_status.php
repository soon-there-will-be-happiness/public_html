    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="admin_top admin_top-flex">
            <div class="admin_top-inner">
                ...
                <div>
                    <h3 class="traning-title mb-0">Изменить статус</h3>
                    <p class="mt-0">для менеджера</p>
                </div>
            </div>
            <ul class="nav_button">
                <li><input type="submit" name="editstatus" value="Сохранить" class="button save button-white font-bold"></li>
        ...
        <div class="admin_form">
            <div class="row-line">
                ...
                <div class="col-1-2">
                    <p class="width-100"><label>Название: </label><input type="text" name="title" placeholder="Название статуса" value="<?=$status['title'];?>" required="required"></p>
                    <p class="width-100"><label>Описание:</label><textarea rows="4" cols="45" name="status_desc"><?=$status['status_desc'];?></textarea></p>
