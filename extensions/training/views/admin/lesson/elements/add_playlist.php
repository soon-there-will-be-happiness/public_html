            ...
            <form  enctype="multipart/form-data" action="/admin/training/lessons/element/add" method="POST">
                ...
                <div class="admin_form">
                    ...
                    <div class="row-line mt-20 add-playlist-line">
                        ...
                        <div id="add_pl_watermark_param" class="hidden">
                            ...
                            <div class="width-100"><label data-uk-tooltip=""
                                ...
                                <input id="add_media_cover" type="number" name="params[show_watermark_visible]"
                                       placeholder="">
                            </div>
                            <div class="width-100"><label>Длительность скрытия в секундах</label>
                                <input id="add_media_cover" type="number" name="params[show_watermark_hidden]"
                                       placeholder="">
                            </div>
                        </div>
